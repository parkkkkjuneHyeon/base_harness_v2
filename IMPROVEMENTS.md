...
## 열린 항목 없음 (2026-07-05 기준)

2차 백로그(12~20번)까지 전부 처리 완료. 아래 "처리 완료" 섹션과
`.claude/decisions/0014`·`0015`, 그리고 `IMPROVEMENTS_REPORT.md`(작업·검증 상세 보고) 참고.

## 다음에 새 항목이 생기면

기존 형식(문제 → 개선안 → 대상 파일 → 난이도)을 그대로 쓰고, 문서 상단 "작업 방식"을 따를 것.

---

## 처리 완료 (2026-07-05) — 2차 백로그 12~20번
